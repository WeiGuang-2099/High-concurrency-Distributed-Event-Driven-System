CREATE DATABASE IF NOT EXISTS `seata_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `seata_db`;

-- Seata Server transaction coordination tables (official schema)
...
CREATE TABLE IF NOT EXISTS `lock_table` (
    ...
    INDEX `idx_xid_and_branch_id` (`xid`, `branch_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
